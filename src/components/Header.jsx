...
const Header = () => {
    ...
    return (
        <div className="flex flex-col">
            <header className='.header-container w-full h-16 md:h-20 '>
                <div className='container mx-auto flex items-center justify-between h-full p-4 md:p-8'>
                    {/* Logo */}
            ...
            {/* Background Search */}
    <div className='bg-custom-blue w-full h-[12rem] flex justify-center items-center'>
    <div className='header-container w-[90%] md:w-[48rem] h-[6rem] rounded-lg shadow-lg flex items-center p-4'>
        ...
        <input
            type="text"
            placeholder="Search..."
            className="header-container w-full h-full pl-4 outline-none text-gray-700"
        />
    </div>
</div>
